...
function GenerateQuadsBricks(atlas)
    ...
    for i = 0,5 do
        quads[counter] = love.graphics.newQuad(x,y+32,32,16,atlas:getDimensions())
        counter = counter + 1
        x = x+32
    end
    local x = 0
    ...
    for i = 0,2 do 
        quads[counter] = love.graphics.newQuad(x,y+48,32,16,atlas:getDimensions())
        counter = counter +1
        x = x+32
    end
    local x = 0

    quads[22]= love.graphics.newQuad(x+160,y+48,32,16,atlas:getDimensions())
