...
function PlayState:init()
    ...
    self.player.stateMachine = StateMachine {
        ...
        ['pot-throw'] = function() return PlayerThrowState(self.player,self.dungeon,self.currentRoom) end,
        ['pot-lift-idle']= function() return PlayerPotIdleState(self.player,self.dungeon) end
    }
