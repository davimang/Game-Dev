--[[
    ...
    Authors: Colton Ogden, David Moroniti
...
function love.load()
    ...
    sounds = {
        ...
        ['pause'] = love.audio.newSource('pause_sound1.wav','static'),
...
function love.update(dt)
    ...
    if scrolling == false then
        ...
        function PlayState:render()
            if love.keyboard.isDown('w') and scrolling == false then
                love.graphics.draw(Pause_image,VIRTUAL_WIDTH/4,VIRTUAL_HEIGHT/4)
            end
